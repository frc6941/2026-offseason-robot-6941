...
public class HubShiftUtil {
    ...
    private static final double maxTimeOfFlight = 1.625;
    ...
    public static void initialize() {
        shiftTimerOffset = 0;
        shiftTimer.restart();
        Logger.recordOutput("Competition/AutoResultSent", false);
        SmartDashboard.putBoolean("Competition/AutoResultSent", false);
    }
