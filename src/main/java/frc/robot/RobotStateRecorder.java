...
import frc.robot.subsystems.ShotFrame;
...
public class RobotStateRecorder extends TransformRecorder {
    public static void putPoseWorldRobot(Pose3d pose, Time time) {
        RobotStateRecorder.getInstance().putTransformWorldRobot(pose, time);
    }

    public static void putPoseWorldRobot(Pose2d pose, Time time) {
        RobotStateRecorder.getInstance().putTransformWorldRobot(pose, time);
    }
