...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    indicatorSubsystem.setDefaultCommand(indicatorSubsystem.indicate(IndicatorIO.Patterns.NORMAL));
  }
  ...
  private void configureBindings() {
    ...
    driver
        ...
        .onTrue(
            shootingSuperstructure.runFrame(
                () -> new ShotFrame(Degrees.of(0), Degrees.of(0), MetersPerSecond.of(0))));
    driver
        .povLeft()
        .onTrue(
            shootingSuperstructure.runFrame(
                () -> new ShotFrame(Degrees.of(-90), Degrees.of(0), MetersPerSecond.of(0))));
    driver
        .povRight()
        .onTrue(
            shootingSuperstructure.runFrame(
    ...
    driver
        ...
        .onTrue(
            shootingSuperstructure.runFrame(
                () -> new ShotFrame(Degrees.of(180), Degrees.of(0), MetersPerSecond.of(0))));
