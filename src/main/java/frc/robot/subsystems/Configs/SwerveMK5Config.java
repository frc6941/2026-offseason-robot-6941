...
public final class SwerveMK5Config {
    ...
    public static SwerveModuleLimit kDefaultSwerveModuleLimit =
            SwerveModuleLimit.builder()
                    ...
                    .maxDriveVelocity(InchesPerSecond.of(999999999))
                    .maxDriveAcceleration(MetersPerSecondPerSecond.of(99999999))
    ...
    public static SwerveLimit kDefaultSwerveLimit =
            SwerveLimit.builder()
                    ...
                    .maxSkidAcceleration(MetersPerSecondPerSecond.of(2000)) // <maxDriveAcceleration
                    // omega_max ≈ vMax / r.
