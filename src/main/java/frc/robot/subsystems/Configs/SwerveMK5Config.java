...
public final class SwerveMK5Config {
    ...
    public static SwerveConfig.SwerveModuleConfig kModuleCompBL =
            SwerveConfig.SwerveModuleConfig.builder()
                    ...
                    .steerMotorEncoderOffset(Rotations.of(is10541 ? -0.11083984375 : 0.1650390625))
                    .driveInverted(false)
                    .steerInverted(false)
    ...
    public static SwerveConfig.SwerveModuleConfig kModuleCompFL =
            SwerveConfig.SwerveModuleConfig.builder()
                    ...
                    .encoderId(9)
                    .driveMotorEncoderOffset(Degree.of(0))
                    .steerMotorEncoderOffset(Rotations.of(is10541 ? 0.3994140625 : 0.005126953125))
                    .driveInverted(false)
                    .steerInverted(false)
                    .encoderInverted(false)
                    .build();
    public static SwerveConfig.SwerveModuleConfig kModuleCompBR =
            SwerveConfig.SwerveModuleConfig.builder()
                    ...
                    .steerMotorEncoderOffset(
                            Rotations.of(is10541 ? -0.12939453125 : 0.219970703125))
                    .driveInverted(true)
                    .steerInverted(false)
                    .encoderInverted(false)
                    .build();
    public static SwerveConfig.SwerveModuleConfig kModuleCompFR =
            SwerveConfig.SwerveModuleConfig.builder()
                    ...
                    .driveMotorEncoderOffset(Degree.of(0))
                    .steerMotorEncoderOffset(
                            Rotations.of(is10541 ? -0.462158203125 : 0.263916015625))
                    .driveInverted(true)
                    .steerInverted(false)
                    .encoderInverted(false)
                    .build();
