...
public class TurretConfig {
  ...
  public static final Angle TURRET_SOFT_LIMIT_CW = TURRET_DOF.unaryMinus().plus(TURRET_ZERO_OFFSET);
  public static final SubsystemConfig TURRET_CONFIG =
      SubsystemConfig.builder()
          ...
          .simConfig(SubsystemConfig.SimConfig.builder().gearRatio(TURRET_GEAR_RATIO).build())
          .build();
