...
public class IntakeConfig {
    ...
    private static final double INTAKER_ROLLER_STATOR_CURRENT_LIMIT_AMPS = 55;
    ...
    public static final class IntakerExtensionParams {
        ...
        public static final double deployPosMeters = 0.30;
        public static final double feedPosMeters = 0.15;
