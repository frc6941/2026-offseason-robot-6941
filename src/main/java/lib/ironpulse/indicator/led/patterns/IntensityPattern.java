...
public class IntensityPattern implements AddressableLEDPattern {
    ...
    @Setter private double intensity;

    /**
     * Constructs an IntensityPattern with a default low color of black and a specified high color
     * and intensity
     *
    ...
    // Sets the LEDs in the buffer to a color interpolated between lowColor and highColor based on
    // intensity
    @Override
