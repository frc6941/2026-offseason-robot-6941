...
/**
 * Builder-style configuration container for a TalonFX-based MotorIO implementation.
 * Mirrors the convenience of {@link lib.ironpulse.swerve.SwerveConfig} for mechanism motors.
 *
 * Intent:
 * - Store all device IDs/buses and Phoenix configurations in one place
 * - Optionally enable a remote CANcoder (raw/sync/fused) for feedback processing inside the IO
