...
/**
 * Velocity subsystem for velocity-controlled mechanisms (shooters, intakes, etc.)
 * Extends {@link MotorSubsystem} with velocity control, velocity-at-goal checking,
 * and tunable PID.
 */
public class VelocityMotorSubsystem<T extends MotorInputsAutoLogged, U extends MotorIO> extends MotorSubsystem<T, U> {
  ...
  public VelocityMotorSubsystem(SubsystemConfig config, T inputs, U io, VelocityParamSources params) {
  ...
  public static class VelocitySetpoint {
    ...
    private VelocitySetpoint(ModeVelocity modeVelocity, AngularVelocity velocitySetpt, DoubleSupplier openLoop) {
