...
public class ImuIOPigeon implements ImuIO {
    ...
    public ImuIOPigeon(SwerveSJTU6Config config) {
        ...
        // Get the shared sync thread from swerve modules (it should already be created
        // by now)
    ...
    // Note: No need for startSyncThread() method since we use the shared sync
    // thread from SwerveModuleIOSJTU6
