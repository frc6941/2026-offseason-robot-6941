...
public class DecisionTree {
    ...
    @Getter private Command currentCommand;
    ...
    public DecisionTree addDecision(Command from, Command to, BooleanSupplier condition) {
    ...
    /**
     * Call this every scheduler cycle. It will: 1) schedule root on first tick 2) when
     * currentCommand finishes, test outgoing edges in iteration order and schedule the first target
     * whose supplier returns true.
     */
    public void tick() {
